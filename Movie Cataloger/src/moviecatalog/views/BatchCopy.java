 ...
 * Description:This Dialog window copies marked files.
 * 
 * */
	...
	private void initcomponents() {
		...
		gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel.createSequentialGroup().addContainerGap(180, Short.MAX_VALUE).addComponent(lblCopy)
						.addGap(178))
				.addGroup(gl_panel.createSequentialGroup().addGap(100)
						.addComponent(prgbar, GroupLayout.PREFERRED_SIZE, 224, GroupLayout.PREFERRED_SIZE)
						.addContainerGap(109, Short.MAX_VALUE))
				.addGroup(Alignment.LEADING, gl_panel.createSequentialGroup().addGap(200).addComponent(lblupdate)
						.addContainerGap(200, Short.MAX_VALUE)));
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(Alignment.LEADING).addGroup(gl_panel
				.createSequentialGroup().addGap(35).addComponent(lblCopy).addGap(18)
				.addComponent(prgbar, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(lblupdate)
			...
			for (i = 0; i < counter; i++) {
				for (j = 0; j < n; j++) {
					...
					if (chk) {
						...
						obj.setPrgbar(obj.getPrgbar().getValue() + 1); // Progress bar updated
						obj.setLblupdtae((i+1)+"/"+counter + " Movies copied");// Movies copied count updated
